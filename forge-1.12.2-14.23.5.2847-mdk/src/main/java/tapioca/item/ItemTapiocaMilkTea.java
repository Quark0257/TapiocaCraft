...
public class ItemTapiocaMilkTea extends ItemFood
{
	public ItemTapiocaMilkTea() 
	{
		super(11,0.8F, false);
	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving)
	{
		if(!worldIn.isRemote)
		{
			...
			entityLiving.addPotionEffect(new PotionEffect(MobEffects.SPEED,2400,1));
			entityLiving.addPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST,2400,1));
